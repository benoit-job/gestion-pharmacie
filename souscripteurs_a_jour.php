...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="fr-FR" dir="ltr">
  ...
  <head>
    ...
    <title>Souscripteurs à jour</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="content">
        ...
        <div class="pb-3">
            <div class="mb-8">
              <h3 class="mb-2">Souscripteurs à jour</h3>
              <h5 class="text-body-tertiary fw-semibold">Visualiser vos Souscripteurs à jour </h5>
            </div>
                        ...
                        <table class="table table-hover m-0 usersTable" style="width:100%" data-title="Souscripteurs à Jour">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT s.*,
                                        ...
                                        LEFT JOIN versements_souscripteurs AS v ON v.id_souscripteur = s.id_souscripteur
                                        GROUP BY s.id_souscripteur
                                        HAVING total_verse >= s.montant_souscrit
