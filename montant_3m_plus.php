...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="fr-FR" dir="ltr">
  ...
  <head>
    ...
    <title>SOUSCRIPTION de 750 000 F - plus</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="content">
        ...
        <div class="pb-3">
            <div class="mb-8">
              <h3 class="mb-2">souscripteur de 3 000 000 F - plus</h3>
              <h5 class="text-body-tertiary fw-semibold">Visualiser vos souscripteur de 3 000 000 F - plus </h5>
            </div>
            ...
            <div class="page-section">
                <div class="card card-fluid">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover m-0 usersTable" style="width:100%" data-title="SOUSCRIPTION 3 000 000F et plus">
    <thead class="thead-">
    ...
    <tbody>
        ...
        $query = "SELECT s.*,
                ...
                LEFT JOIN versements_souscripteurs AS v ON v.id_souscripteur = s.id_souscripteur
                GROUP BY s.id_souscripteur
                HAVING s.montant_souscrit >= 3000000
