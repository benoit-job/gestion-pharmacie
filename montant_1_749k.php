...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="fr-FR" dir="ltr">
  ...
  <head>
    ...
    <title>SOUSCRIPTION de 1F - 749 000F</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="content">
        ...
        <div class="pb-3">
            <div class="mb-8">
              <h3 class="mb-2">souscripteur de 1F - 749 000F</h3>
              <h5 class="text-body-tertiary fw-semibold">Visualiser vos souscripteur de 1F - 749 000F </h5>
            </div>
                        ...
                        <table class="table table-hover m-0 usersTable" style="width:100%" data-title="SOUSCRIPTION de 1F - 749 000F">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT s.*,
                                        ...
                                        LEFT JOIN versements_souscripteurs AS v ON v.id_souscripteur = s.id_souscripteur
                                        GROUP BY s.id_souscripteur
                                        HAVING s.montant_souscrit BETWEEN 1 AND 749000
                                ...
                                while($souscripteur = mysqli_fetch_array($resultat)) {   
                                    ...
                                    $statut = "SOUSCRIPTION DE 1F - 749 000F";
