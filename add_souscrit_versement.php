    ...
    <div class="content">
        <div class="pb-3">
            ...
            <div class="page-section">
                <form id="formVersement" method="post" action="traitement_versement.php">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered versement-table m-0" id="versementTable" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="nature[]" class="form-control form-control-sm" placeholder="Nature" required></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
